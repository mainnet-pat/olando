 ...
 */
export const fundProposedTrade = async ({ wallet, tradeProposal, txFeePerByte = 1n, burnDustTokens = true, }) => {
    const exlab = new ExchangeLab();
    const tokenBalances = [
    ...
    const utxoList = await wallet.getAddressUtxos(wallet.cashaddr);
    const inputCoins = [];
