...
export const donate = async ({ aliceAddress, alicePriv, wallet, provider, olandoCategory, councilMultisigContract, adminMultisigContract, donationTokenAmount, }) => {
    ...
    const donationUtxo = utxos.find(utxo => utxo.token?.category === olandoCategory &&
