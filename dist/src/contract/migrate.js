...
export const migrate = async ({ provider, adminMultisigContract, councilMultisigContract, newAdminMultisigContractAddress, newIssuanceFundContractAddress, aliceAddress, alicePriv, signatures, olandoCategory, send = true, }) => {
