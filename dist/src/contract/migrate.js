...
export const migrate = async ({ provider, adminMultisigContract, councilMultisigContract, newAdminMultisigContract, newCouncilMultisigContract, aliceAddress, alicePriv, signatures, send = true, }) => {
    ...
    const newIssuanceFundContract = new Contract(IssuanceFundArtifact, [addressToLockScript(newCouncilMultisigContract.address), addressToLockScript(newAdminMultisigContract.address)], { provider, addressType: 'p2sh20' });
