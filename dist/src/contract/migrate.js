...
export const migrate = async ({ provider, adminMultisigContract, councilMultisigContract, newAdminMultisigContractAddress, newIssuanceFundContractAddress, address, privKey, signatures, olandoCategory, send = true, }) => {
    ...
    if (send) {
        ...
        console.log("not sending partially signed tx");
