...
export declare const investInIssuanceFund: ({ investAmountBch, provider, address, privKey, wallet, councilMultisigContract, adminMultisigContract, olandoCategory, }: {
