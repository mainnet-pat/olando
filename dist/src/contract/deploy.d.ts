...
export declare const deployContractFromAuthGuard: ({ deployerAddress, deployerPriv, provider, councilContract, adminContract, olandoCategory, deploymentMtp, }: {
    ...
    issuanceFundContract: Contract<{
        ...
        readonly updatedAt: "2025-06-27T05:13:17.747Z";
    }, {
    ...
    councilFundContract: Contract<{
        ...
        constructorInputs: [];
        functions: {
            spend: (functionParameters_0: string | Uint8Array<ArrayBufferLike> | SignatureTemplate, functionParameters_1: string | Uint8Array<ArrayBufferLike> | SignatureTemplate, functionParameters_2: bigint) => import("cashscript").Transaction;
        };
        unlock: {
            spend: (functionParameters_0: string | Uint8Array<ArrayBufferLike> | SignatureTemplate, functionParameters_1: string | Uint8Array<ArrayBufferLike> | SignatureTemplate, functionParameters_2: bigint) => import("cashscript").Unlocker;
        };
    }>;
}>;
