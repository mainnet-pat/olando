...
export const deployContractFromAuthGuard = async ({ deployerAddress, deployerPriv, provider, councilContract, adminContract, olandoCategory, deploymentMtp, }) => {
    ...
    const builder = new TransactionBuilder({ provider })
        ...
        token: {
            ...
            amount: authGuard.authGuardUtxo.token.amount - 888888888888888n, // 2 decimals
        }
    })
        .addOutput(authGuard.authKeyUtxo.token
        ? {
        ...
        amount: 1000n,
        token: {
            amount: 888888888888888n, // 2 decimals
            category: olandoCategory,
            nft: {
                capability: 'mutable',
