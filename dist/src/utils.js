...
export const MaxTokenSupply = 853060096864n; // initial contract supply
//export const AuthGuardInitialSupply = 8888888888888888_88n; // OLA genesis supply
export const AuthGuardInitialSupply = 8888888888888888n; // TTT genesis supply
...
export const toMainnetUtxo = (utxo) => ({
